...
/// A flag to toggle the Dubin's heuristic, this should be false,
//  if reversing is enabled (true = on; false = off)
static const bool dubins = true;

static const float dubins_len_beishu = 5;
...
/*!
   ...
   \brief A flag to toggle the Dubin's heuristic via lookup, 
   \  potentially speeding up the search by a lot
...
static const double appden_max = 5;

// 机器的最小转弯半径
/// [m] --- The minimum turning radius of the vehicle
static const float r = 6;

// theta 的离散分辨率 72 * 5 = 360
...
// ___________________
// HEURISTIC CONSTANTS
// H 代价的常值参数  前进变相 后退变相 前进变后退 后退变前进等等 
